...
int main(void) {
 ...
 // set_bit_value(&bits, 32, 1); // howw toprintf in binary?????
  s21_decimal bits2 = {0b00001010, 0b000, 0b000, 0b00000000000000000000000000000};
  s21_decimal bits3 = {0b00000001, 0b0000110, 0b000101, 0b00000000000000000000011100000000};
