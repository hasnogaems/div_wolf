...
START_TEST(is_less_or_equal_case_1) {
  // float num1 = 5.355;
  // float num2 = 5.35;
...
START_TEST(is_less_or_equal_case_2) {
...
START_TEST(is_less_or_equal_case_3) {
  // float num1 = 5.35;
  // float num2 = 5.35;
...
START_TEST(is_less_or_equal_case_4) {
  // float num1 = 5.35;
  // float num2 = -5.35;
  s21_decimal dec1 = {{0x00000217, 0x0, 0x0, 0x00020000}};
...
START_TEST(is_less_or_equal_case_5) {
  // int num1 = 0;
  // int num2 = 0;
...
START_TEST(is_less_or_equal_case_6) {
  // int num1 = 3;
  // int num2 = 55;
...
START_TEST(is_less_or_equal_case_7) {
  // int num1 = -55;
  // int num2 = -55;
...
START_TEST(is_less_or_equal_case_8) {
...
START_TEST(is_less_or_equal_case_9) {
...
START_TEST(is_less_or_equal_case_10) {
...
Suite *suite_is_less_or_equal(void) {
  Suite *s = suite_create("\033[1;31m--is less or equal--\033[m");
  TCase *tc = tcase_create("is less or equal");

  tcase_add_test(tc, is_less_or_equal_case_1);
  tcase_add_test(tc, is_less_or_equal_case_2);
  tcase_add_test(tc, is_less_or_equal_case_3);
  tcase_add_test(tc, is_less_or_equal_case_4);
  tcase_add_test(tc, is_less_or_equal_case_5);
  tcase_add_test(tc, is_less_or_equal_case_6);
  tcase_add_test(tc, is_less_or_equal_case_7);
  tcase_add_test(tc, is_less_or_equal_case_8);
  tcase_add_test(tc, is_less_or_equal_case_9);
  tcase_add_test(tc, is_less_or_equal_case_10);
