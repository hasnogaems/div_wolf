...
Suite *suite_is_less(void) {
  Suite *s = suite_create("\033[1;31m--is less--\033[m");
  TCase *tc = tcase_create("is less");

  tcase_add_test(tc, is_less_case_1);
  tcase_add_test(tc, is_less_case_2);
  tcase_add_test(tc, is_less_case_3);
  tcase_add_test(tc, is_less_case_4);
  tcase_add_test(tc, is_less_case_5);
  tcase_add_test(tc, is_less_case_6);
  tcase_add_test(tc, is_less_case_7);
  tcase_add_test(tc, is_less_case_8);
